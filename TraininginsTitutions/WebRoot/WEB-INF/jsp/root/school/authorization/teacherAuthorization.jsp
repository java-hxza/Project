						...
						<div class="card-body p-4">
							...
							<form action="javascript:void(0)">
								...
								<div class="form-group">
									...
									<c:forEach items="${teacherDictionListByTeacherId }" begin="0" end="0" var="t">
										<input class="form-control" type="text" id="teacherId" name="${t.teacher.teacherId }" value="${t.teacher.teacherName }" disabled>
									</c:forEach>
								</div>
								...
								<div class="form-group mb-0 text-center">
									<button class="btn btn-primary" type="button" onclick="authorization()" >授权</button>
								</div>
