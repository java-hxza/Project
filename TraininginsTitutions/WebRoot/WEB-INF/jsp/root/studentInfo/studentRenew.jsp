													...
													<div class="card-body">
														...
														<div class="table-responsive">
															...
															<table
																...
																<tbody>
																	<c:forEach items="${renewOrderList }" var="ts" varStatus="status">
																		<tr>
																			...
																			<td class="table-user">${ts.discount+ts.dpMoney }</td>
																			<td class="table-user">${ts.dpMoney }</td>
																			<td class="table-user">${(ts.discount+ts.dpMoney)-ts.dpMoney }</td>
																		</tr>
																	</c:forEach>
																</tbody>
															</table>
