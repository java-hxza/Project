						...
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									<div class="row mb-2">
										<div class="col-sm-4">
											<a href="javascript:void(0);" onclick="updateCurriclum()"class="btn btn-danger mb-2"><i
												class="mdi mdi-plus-circle mr-2" ></i> 修改课程</a>
										</div>
										<div class="col-sm-8">
											<div class="text-sm-right">
												<button type="button" class="btn btn-success mb-2 mr-1"onclick="createCurriclum(${classId})">
													<i class="mdi mdi-plus-circle mr-2" ></i>  添加课程 </button>
												<button type="button" class="btn btn-light mb-2 mr-1"  onclick="delCurriclum(${classId})" > 删除课程</button>
											</div>
										</div>
										<!-- end col-->
									</div>
                                <!-- Question/Answer -->
                                	<div class="table-responsive">
										<table class="table table-centered table-striped dt-responsive nowrap w-100"
											...
											<tbody>
												<c:forEach items="${curriculumInfoList}" var="cur" varStatus="status">
													<tr>
														<td>
															<div class="custom-control custom-checkbox">
																<input type="checkbox" class="custom-control-input customCheckes" > <label class="custom-control-label customCheck" for="customCheck2">&nbsp;</label>
															</div>
														</td>
														<td class="table-user"><a href="javascript:void(0);"
															class="text-body font-weight-semibold" name="${cur.teacherHourId}">${status.index }</a>
														</td>
														<td class="table-user"><a href="javascript:void(0);"
															class="text-body font-weight-semibold">${cur.dpName}</a>
														</td>
														<td class="table-user"><a href="javascript:void(0);"
															class="text-body font-weight-semibold" >${cur.teacherName }</a>
														</td>
														<td class="table-user"><a href="javascript:void(0);"
															class="text-body font-weight-semibold" > <fmt:formatDate value="${cur.startTime }" pattern="yyyy-MM-dd MM:ss"/> </a>
														</td>
														<td class="table-user"><a href="javascript:void(0);"
