...
<div class="left-side-menu" style="background: #344451;"
	data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-54"
	data-genuitec-path="/TraininginsTitutions/WebRoot/WEB-INF/jsp/leftSidebar/leftSidebar.jsp">
			...
			<li class="side-nav-item"><a href="javascript: void(0);"
				...
				<ul class="side-nav-second-level" aria-expanded="false">
					<li><a href="javascript:void(0)"
						onclick="Accountinformation()">账户信息</a></li>
					<li><a href="javascript:void(0)" onclick="Incomeitems()">收入项目</a></li>
					<li><a href="javascript:void(0)"
						onclick="Expenditureitemses()">支出项目</a></li>
