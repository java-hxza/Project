...
<body>
	...
	<div class="wrapper">
		...
		<!-- ========== Left Sidebar Start ========== -->
		<%@include file="/WEB-INF/jsp/teacher/teacherBar/leftSidebar.jsp" %>
		<!-- Left Sidebar End -->
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table
											...
											<tbody>
												<c:forEach items="${teacherClassList}" var="class">
													<tr>
														<td>
															<div class="custom-control custom-checkbox">
																<input type="checkbox" class="custom-control-input"
														...
														<td class="table-user"><a href="javascript:void(0);"
															class="text-body font-weight-semibold">${class.classNumber }</a>
														</td>
														<td class="table-user"><a href="javascript:void(0);"
															class="text-body font-weight-semibold">${class.className}</a>
														</td>
														<td class="table-user"><a href="javascript:void(0);"
															class="text-body font-weight-semibold">${class.departmentOfPediatrics.dpTypeName}</a>
														</td>
														<td class="table-user"><a href="javascript:void(0);"
															class="text-body font-weight-semibold">${class.headmaster}</a>
														</td>
														<td class="table-user"><a href="javascript:void(0);"
															class="text-body font-weight-semibold">${class.school.schoolName}</a>
														</td>
													</tr>
												</c:forEach>
											</tbody>
