...
<body class="authentication-bg">
				...
				<div class="col-lg-5">
					<div class="card">
						...
						<div class="card-header pt-4 pb-4 text-center bg-primary">
							<a href="index.html"> <span> <!-- 	<img src="assets/images/logo.png" alt="" height="18"> --></span>
							</a>
						</div>
						...
						<div class="card-body p-4">
							...
							<div class="form-group">
								<label for="emailaddress">学校：</label> <select id="schoolId"
									class="form-control" name="schoolId">
							...
							<div class="form-group">
								<label for="emailaddress">用户身份：</label><select id="userTypeId"
									class="form-control" onchange="userType()" name="userTypeId">
							...
							<div class="form-group" id="d1" hidden="hidden" >
								<label for="emailaddress">用户身份：</label> <select id="state"
									class="form-control" name="state">
									<option value="">请选择修改权限</option>
							...
							<div class="form-group">
								<label for="emailaddress">登录名：</label> <input
									...
									name="loginName" required placeholder="警告 登录名只可创建一次并且不可修改"
									onblur="loginNameVerification()">
							</div>
					...
					<div class="row mt-3">
						<div class="col-12 text-center">
							<p class="text-muted">
								还没有账户? <a href="#" class="text-muted ml-1"><b>请登录管理员账号创建账户</b></a>
							</p>
						</div>
						<!-- end col -->
					</div>
	...
	<footer class="footer footer-alt"> 2018 - 2019 © - Order.com </footer>
