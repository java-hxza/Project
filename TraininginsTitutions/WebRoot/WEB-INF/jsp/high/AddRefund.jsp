...
<body>
	...
	<div class="wrapper">
		...
		<div class="content-page">
							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item"><a
											href="javascript: void(0);">其他收费单</a></li>
									</ol>
								</div>
								<h4 class="page-title">其他费用收费单</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
										...
										<div class="col-md-12">
											<form>
												<div class="row">
													...
													<span class="SK" style="display: none;" feecateId="${order.feecateId }" chargeTypeName="${order.feeCategory.chargeTypeName }"></span>
													<div class="col-md-6">
														<div class="form-group mb-3">
															<label for="example-select">付款方</label> <select
																...
																<c:forEach items="${high }" var="h">
																	<option value="${h.studentId }" class="delSt"
																		name="${h.childrenesClassStudnet.classId }"
																		>${h.studentName}</option>
																</c:forEach>
															</select>
														</div>
													</div>
													<div class="col-md-6">
													<div class="form-group mb-3">
														<label for="example-number">购买课时</label> <input
															type="text" class="form-control addhours"
												...
												<div class="col-md-6">
													<div class="form-group mb-3">
														<label for="example-number">赠送课时</label> <input
															type="text" class="form-control givehours"
															data-toggle="input-mask"
															data-mask-format="00000000000000000" data-reverse="true"
															value="0" readonly="readonly">
													</div>
												...
												<div class="col-md-6">
													<div class="form-group mb-3">
														<label for="example-number">剩余课时</label> <input
													...
													<div class="col-md-6">
														<div class="form-group mb-3">
															<label for="example-number">实交金额</label> <input
																class="form-control feecateMoney" id="example-number"
																type="number" name="number" readonly="readonly">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group mb-3">
															<label for="example-number">退款金额</label> <input
																class="form-control feecateMoneys" id="example-number"
			...
			<script type="text/javascript"
				src="${Path }/static/js/highes/AddRefund.js"></script>
			<!-- third party js ends -->
</body>
</html>
<!-- <div class="form-group">
