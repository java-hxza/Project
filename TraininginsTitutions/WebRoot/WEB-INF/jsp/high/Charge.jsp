...
<body>
	...
	<div class="wrapper">
		...
		<!-- Topbar Start -->
						...
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									...
									<div class="row mb-2">
										<table id="ChargePeriods" border="1" width="1600">
											<tr>
										...
										<div class="col-md-12">
											<form class="needs-validation" novalidate>
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group mb-3">
															<label for="example-number">打折金额</label> <input
			...
			<script type="text/javascript" src="${Path }/static/js/Excel/base64.js"></script>
			<script type="text/javascript" src="${Path }/static/js/Excel/tableExport.js"></script>
			<script type="text/javascript">
