			...
			<div class="content">
						...
						<li class="dropdown notification-list"><a
							...
							<!-- item-->
								<a href="welCome.html" class="dropdown-item notify-item">
									<i class="mdi mdi-lifebuoy mr-1"></i> <span>退出
									</span>
								</a>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<h4 style="text-align:center">优惠活动</h4>
								<div class="card-body showActivitySchooles">
									<div class="row mb-2">
										<div class="col-sm-4">
											<a href="javascript:void(0);" class="btn btn-danger mb-2"
												onclick="addActivitySchooles()"><i
								...
								<!-- end card-->
								<div class="row mb-2 addActivitySchooles" style="display: none;">
									<div class="col-md-12">
