								...
								<li class="dropdown notification-list"><a
									...
									<div
										...
										<a href="javascript:void(0);"
											...
											class="mdi mdi-account-circle mr-1"></i> <span>我的账户</span>
										</a>
										...
										<a href="javascript:void(0);"
											class="dropdown-item notify-item"> <i
											class="mdi mdi-lifebuoy mr-1"></i> <span>设置 </span>
										</a>
													...
													<form class="needs-validation">
														<div class="form-group position-relative mb-3">
															...
															<label for="validationTooltip01">请再次密码</label> <input
																...
																id="exampleInputPassword1" placeholder="请再次填写密码"
																required> <label for="validationTooltip01">职业</label>
															<div class="row">
																<div class="col-12">
