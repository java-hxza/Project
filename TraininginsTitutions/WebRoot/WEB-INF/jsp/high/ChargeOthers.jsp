							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item"><a
											href="javascript: void(0);">其他费用收款单</a></li>
									</ol>
								</div>
								<h4 class="page-title">其他费用收款单</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
												...
												<div class="card-body">
													...
													<div class="table-responsive mt-4 Expenditureitemses">
														...
														<c:if test="${JY == 1 }">
															...
															<a
																href="${pageContext.request.contextPath }/selectOrderOthers.html?orderCounts=0&classId=0&studentName=000111"><input
																type='button' class='btn btn-info button-next'
																name='next' value="首页" /></a> <a
																href="${pageContext.request.contextPath }/selectOrderOthers.html?classId=0&studentName=000111&orderCounts= ${orderCounts - 2 }"><input
																...
																href="${pageContext.request.contextPath }/selectOrderOthers.html?classId=0&studentName=000111&orderCounts= ${orderCounts}"><input
																type='button' class='btn btn-info button-next'
																name='next' value="下一页" /></a> <a
																href="${pageContext.request.contextPath }/selectOrderOthers.html?classId=0&studentName=000111&orderCounts= ${orderCount }"><input
																type='button' class='btn btn-info button-last'
