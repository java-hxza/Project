                    ...
                    <div class="card-body">
                        ...
                        <form action="#">
                            ...
                            <div class="form-group">
                                <label for="fullname">班级标号</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your name" required>
                            </div>
                             <div class="form-group">
                                <label for="fullname">班级名称</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your name" required>
                            </div>
                            <div class="form-group">
                                <label for="fullname">班级类型</label>
                                <select id="dpId" onchange="dpChange()">
                            ...
                            <div class="form-group">
                                <label for="emailaddress">班主任</label>
                                <input class="form-control" type="text" id="headmaster" required placeholder="Enter your email">
                            </div>
                            <div class="form-group">
