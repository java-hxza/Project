$(function() {
	...
	$(".schoolId").unbind("click").click(function() {
		...
		location.href = "childrenStudentHourInfo.html?schoolId=" + schoolId + "&schoolName=" + schoolName;
	});
	...
	queryStudentHour = function(){
		...
		location.href = "queryStudentHour.html?startTime="+startTime+"&endTime="+endTime+"&classId="+classId;
	}
})